# -*- coding: utf-8 -*-
# Generated by Django 1.10 on 2017-09-01 18:27
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('author', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='charasite.Author')),
            ],
        ),
        migrations.CreateModel(
            name='BookInstance',
            fields=[
                ...
                ('book', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='charasite.Book')),
            ],
            options={
                'ordering': ['due_back'],
            },
